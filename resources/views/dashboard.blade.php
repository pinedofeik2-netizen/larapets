...
@section('content')
    ...
    <header class="mb-10 mt-4 w-full max-w-6xl border-b border-base-content/20 pb-6 text-center">
        <h1 id="dashboard-heading" class="inline-flex items-center justify-center gap-3 text-3xl font-semibold text-base-content sm:text-4xl">
            <i class="fa-solid fa-gauge-high text-primary text-4xl sm:text-5xl" aria-hidden="true"></i>
            Dashboard
        </h1>
        <p class="mt-2 text-sm text-base-content/70">Resumen de la aplicación según tu rol.</p>
    </header>
    {{-- Cards --}}
    <div class="flex flex-wrap gap-4 items-center justify-center mb-6">
        ...
        @if (Auth::user()->role == 'Admin')
            {{-- Module Users --}}
            <div class="card w-full max-w-md border border-base-content/10 bg-base-100/90 text-base-content shadow-xl backdrop-blur-md">
                <figure class="h-[240px]">
                    <img class="object-cover w-60 h-60" src="{{ asset('images/IconDashboard.png') }}" />
                </figure>
                <div class="card-body">
                    <h2 class="card-title">
                    ...
                    {{-- Stats --}}
                    <ul class="list rounded-box border border-base-content/10 bg-base-200/80 shadow-inner">
                        <li class="list-row">
                            <div>
                    ...
                    <div class="card-actions justify-end">
                        <a class="btn btn-primary btn-outline mt-3 gap-2" href="{{ url('users') }}">
                            Enter
            ...
            <div class="card w-full max-w-md border border-base-content/10 bg-base-100/90 text-base-content shadow-xl backdrop-blur-md">
                <figure class="h-[240px]">
                    <img class="object-cover w-60 h-60" src="{{ asset('images/IconDashboard2.png') }}" />
                </figure>
                <div class="card-body">
                    <h2 class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-10" fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <div class="card-actions justify-end">
                        <a class="btn btn-primary btn-outline mt-3 gap-2" href="{{ url('pets') }}">
                            Enter
                            <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
            ...
            <div class="card w-full max-w-md border border-base-content/10 bg-base-100/90 text-base-content shadow-xl backdrop-blur-md">
                <figure class="h-[240px]">
                    <img class="object-cover w-60 h-60" src="{{ asset('images/IconDashboard3.png') }}" />
                </figure>
                <div class="card-body">
                    <h2 class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-10" fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <div class="card-actions justify-end">
                        <a class="btn btn-primary btn-outline mt-3 gap-2" href="{{ url('adoptions') }}">
                            Enter
                            <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
        ...
        @if (Auth::user()->role == 'Customer')
            ...
            <div class="card w-full max-w-md border border-base-content/10 bg-base-100/90 text-base-content shadow-xl backdrop-blur-md">
                ...
                <div class="card-body">
                    ...
                    <div class="card-actions justify-end">
                        <a class="btn btn-primary btn-outline mt-3 gap-2" href="{{ url('myprofile') }}">
                            Enter
                            <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
            ...
            <div class="card w-full max-w-md border border-base-content/10 bg-base-100/90 text-base-content shadow-xl backdrop-blur-md">
                ...
                <div class="card-body">
                    ...
                    <div class="card-actions justify-end">
                        <a class="btn btn-primary btn-outline mt-3 gap-2"
